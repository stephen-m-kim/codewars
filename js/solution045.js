...
function turn(current, target) {
    // take strings of current and target positions
    // return the direction that the rover is turning given the current and target positions
    // rover can only make a single turn of 90 degree at a time
    // run conditional and return right of left
...
// const turn = (x, y) => 'NESWN'.includes(x + y) ? 'right' : 'left'; wow clever! .. someone else's solution.. 